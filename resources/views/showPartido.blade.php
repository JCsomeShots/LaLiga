...
<section class="laTabla">
    <div class="cabeceraTabla flex justify-center items-center">
        ...
        <table class="tabla  w-screen  mx-auto text-slate-50 mt-9 mx-10 min-w-min max-w-5xl text-sm rounded-xl">
            <tr>
            ...
            <tr>
                ...
                <td class="txt py-3 px-6 pr-3 pl-4 font-light cursor-pointer hover:text-yellow-900"><a href="{{route('partidosEdit' , $partido)}}" class="fa fa-cogs" style="font-size:20px"></a></td>
            </tr>
            <tr>
                <td class="txt pb-6 font-base pl-4 ">Eliminar</td>
                <td>
                <form action="{{route('destroyPartido' , $partido)}}" method="POST">

                @csrf
                @method('delete')
                        <button type="submit" class="txt pb-6 px-6 pr-3 pl-4 font-light cursor-pointer hover:text-yellow-900">
